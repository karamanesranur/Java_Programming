package Java_Programming_Muhtar.day029_Inheritance.encapsulation;
...
public class Student {
    ...
    public Student(String name, int age, char gender, char grade, String schoolName) { //Constructor body
       setName(name);
        setAge(age);
        setGender(gender);
        setGrade(grade);
